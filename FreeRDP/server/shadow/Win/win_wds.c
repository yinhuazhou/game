                                                                 ...
                                                                 _Out_opt_ UINT* puArgErr)
{
	...
	switch (dispIdMember)
	{
		case DISPID_RDPSRAPI_EVENT_ON_ATTENDEE_CONNECTED:
		{
			...
			vr.__VARIANT_NAME_1.__VARIANT_NAME_2.vt = VT_DISPATCH;
			vr.__VARIANT_NAME_1.__VARIANT_NAME_2.__VARIANT_NAME_3.pdispVal = nullptr;
			...
			pDispatch = vr.__VARIANT_NAME_1.__VARIANT_NAME_2.__VARIANT_NAME_3.pdispVal;
		...
		case DISPID_RDPSRAPI_EVENT_ON_CTRLLEVEL_CHANGE_REQUEST:
		{
			...
			IDispatch* pDispatch;
			IRDPSRAPIAttendee* pAttendee;
			vr.__VARIANT_NAME_1.__VARIANT_NAME_2.vt = VT_INT;
			vr.__VARIANT_NAME_1.__VARIANT_NAME_2.__VARIANT_NAME_3.pdispVal = nullptr;
			...
			level = vr.__VARIANT_NAME_1.__VARIANT_NAME_2.__VARIANT_NAME_3.intVal;
			vr.__VARIANT_NAME_1.__VARIANT_NAME_2.vt = VT_DISPATCH;
			vr.__VARIANT_NAME_1.__VARIANT_NAME_2.__VARIANT_NAME_3.pdispVal = nullptr;
			hr = DispGetParam(pDispParams, 0, VT_DISPATCH, &vr, &uArgErr);
...
int win_shadow_wds_init(winShadowSubsystem* subsystem)
{
	...
	varPropertyValue.__VARIANT_NAME_1.__VARIANT_NAME_2.vt = VT_I4;
	varPropertyValue.__VARIANT_NAME_1.__VARIANT_NAME_2.__VARIANT_NAME_3.intVal = 40000;
	...
	varPropertyValue.__VARIANT_NAME_1.__VARIANT_NAME_2.vt = VT_BOOL;
	varPropertyValue.__VARIANT_NAME_1.__VARIANT_NAME_2.__VARIANT_NAME_3.boolVal = VARIANT_TRUE;
	hr = subsystem->pSessionProperties->lpVtbl->put_Property(subsystem->pSessionProperties,
	                                                         bstrPropertyName, varPropertyValue);
	SysFreeString(bstrPropertyName);
	...
	varPropertyValue.__VARIANT_NAME_1.__VARIANT_NAME_2.__VARIANT_NAME_3.intVal = 2; // AF_INET
