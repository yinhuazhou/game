...
void Title::update( Parent* parent ){
	...
	f.drawDebugString( 0, 0, "[title] : boom man" );//f.drawDebugString(0, 0, "[title] : boom man");
	f.drawDebugString( 1, 2, "one player" );//f.drawDebugString( 1, 2, "one player" );
	f.drawDebugString( 1, 3, "two players" );//f.drawDebugString( 1, 3, "two players" );
	//写光标
